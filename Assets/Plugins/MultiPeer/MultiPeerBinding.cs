...
public class MultiPeerBinding
{
	...
	// Starts/stops advertising the current device. Note that serviceType must be 1–15 characters long and can contain only ASCII lowercase letters, numbers, and hyphens
